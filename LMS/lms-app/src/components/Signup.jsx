...
const ModernInput = ({ label, icon: Icon, error, ...props }) => (
    <div className="space-y-1.5">
        ...
        <div className="relative group">
            ...
            <input
                {...props}
                className={`block w-full pl-11 pr-4 py-3 bg-white border rounded-2xl outline-none ${error ? "border-red-500 bg-red-50" : "border-slate-200"
                    }`}
            />
        </div>
        {error && (
...
const TeacherCard = ({ t, selected, onToggle }) => (
    <button
        ...
        className={`w-full p-4 rounded-2xl border transition-all text-left flex items-center gap-4 ${selected
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <select
                                        className={`w-full p-3 rounded-2xl border ${errors.course
                                ...
                                {formData.course ===
                                    "6-11-classes" && (
                                        <div className="space-y-1.5">
                                            ...
                                            <select
                                                className={`w-full p-3 rounded-2xl border ${errors.grade
                                                    ? "border-red-500 bg-red-50"
                                                    : "border-slate-200"
                                                    }`}
                                                onChange={(e) =>
